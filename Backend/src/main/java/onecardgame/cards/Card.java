...
public abstract class Card {
    ...
    protected Card(final int rank, final String shape) {
    ...
    public String toString() {
        return switch (rank) {
            case TWO_NUMBER -> String.format(CARD_OF_FORMAT, rank, shape);
            ...
            default -> String.format(CARD_OF_FORMAT, rank, shape);
        };
    }
}
